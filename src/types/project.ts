...
export const STATUS_CONFIG: StatusConfig[] = [
  ...
  { code: 'cl_ip', label: 'In Progress (Pending Client Review)', color: 'hsl(190, 70%, 50%)', category: 'client' },
  { code: 'cl_rev', label: 'Pending Client Review', color: 'hsl(210, 80%, 55%)', category: 'client' },
  ...
  { code: 'fi_nr', label: 'Pending Tech Fix / Mattes', color: 'hsl(280, 60%, 55%)', category: 'review' },
